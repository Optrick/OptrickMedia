...
//           <div id="map" data-lat="46.852205" data-lng="-71.282968"></div>

// Google Maps
google.maps.event.addDomListener(window, 'load', loadGoogleMap);
function loadGoogleMap() {    
    $('#map').addClass('loading');    
    var latlng = new google.maps.LatLng(46.852205, -71.282968); // QC
    var settings = {
        zoom: 14,
        center: new google.maps.LatLng(46.852205, -71.282968),
    ...
    var contentString =
        '<div id="info-window">'+
        '<p>Condos LB9<br /> 7615, Rue des Métis, <br />Québec, Québec, G2K 2J6<br /><a href="https://goo.gl/maps/bhv3xiczjSQ2" target="_blank">Google Maps</a></p>'+
        '</div>';
    var infowindow = new google.maps.InfoWindow({
        content: contentString
    });

    var companyImage = new google.maps.MarkerImage('http://lb9.boitebleue.com/images/map-marker2.png',
        //new google.maps.Size(36,62),// Width and height of the marker
        new google.maps.Size(62,62),// Width and height of the marker
        new google.maps.Point(0,0),
        new google.maps.Point(18,52)// Position of the marker 
    );

    var companyPos = new google.maps.LatLng(46.852205, -71.282968);
